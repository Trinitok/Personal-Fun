...
*   Max Kelly
*
*   This code is by George Mossessian at https://rosettacode.org/wiki/MD4
*
*   for more explanation on MD4:
...
/**
*   Message Digest v4 algorithm by Max Kelly
*/
int main(int argc, char *argv[])
{
    ...
    printf("This will make an MD4 hash\n");
    printf("orig msg: %s", msg);
    // this function will return the hash
    char *encrypt = MD4(msg, strlen(msg));

    printf("\n\n\nThe MD4 code generated by the msg is: \n");
    printf("\\t= 0x");
    printf("%s\n", MD4(msg,strlen(msg)));


    printf("\n");
    printf("The msg should be successfully encrypted with MD4\n");
