			...
			if (!URL.exists()) {
				...
				for (int i = 0; i < archivedFiles.length; i++) {
					if (archivedFiles[i].getName().contains(".jpg")) {
						...
						JButton archivedFile = new JButton(
								archivedFiles[i].getName());
				...
				this.addMouseListener(new MouseAdapter() {
					...
					public void mousePressed(MouseEvent e) {
						...
						try {
							...
							// get the string and handle spaces for the google
							// image search
							String a = ControlPanel.this.In.getText();
							a = a.replaceAll(" ", "+");
							// check to see if file exists
							if (!(new File(
									"Magic the Gathering Archived Files\\" + a
											+ ".jpg").exists())) {
								...
								String imageDest = "Magic the Gathering Archived Files\\"
										+ a + ".jpg";
								...
								archivedCard
										.addMouseListener(new MouseAdapter() {
											...
											public void mousePressed(
													MouseEvent e) {
												File readThis = new File(
														"Magic the Gathering Archived Files\\"
																+ archivedCard
																		.getText()
																+ ".jpg");
												BufferedImage image;
							...
							MagicFrame.this.cs.setText("Card Name:"
									+ "\nCard Type:" + "\nMana Cost:"
									+ "\nCard Text:");
							...
							while ((inputLine = in.readLine()) != null) {
								...
								if (inputLine
										.contains("<div class=\"label\" style=\"font-size: .7em;\">")) {
									inputLine = in.readLine();
									inputLine = in.readLine();
									inputLine = in.readLine();
									inputLine = inputLine.replaceAll(" ", "");
								...
								if (inputLine.contains("cardtextbox")) {
									...
									inputLine = inputLine
											.replaceAll(
													"<div class=\"cardtextbox\" style=\"padding-left:10px;\">",
													"");
					...
					public void actionPerformed(ActionEvent e) {
						...
						try {
							...
							while ((inputLine = in.readLine()) != null) {
								...
								if (inputLine
										.contains("<div class=\"cardtextbox\" style=\"padding-left:10px;\">")) {
									inputLine = inputLine.replaceAll("</div>",
											"");
									inputLine = inputLine.replaceAll("  ", "");
									inputLine = inputLine
